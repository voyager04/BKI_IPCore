...
Partial Public Class DS_CM_DM_TU_DIEN
    ...
    Partial Public Class CM_DM_TU_DIENDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCM_DM_TU_DIENRow(ByVal ID As Decimal, ByVal MA_TU_DIEN As String, ByVal ID_LOAI_TU_DIEN As Decimal, ByVal TEN_NGAN As String, ByVal TEN As String) As CM_DM_TU_DIENRow
            Dim rowCM_DM_TU_DIENRow As CM_DM_TU_DIENRow = CType(Me.NewRow,CM_DM_TU_DIENRow)
            Dim columnValuesArray() As Object = New Object() {ID, MA_TU_DIEN, ID_LOAI_TU_DIEN, TEN_NGAN, TEN}
