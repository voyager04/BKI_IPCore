...
namespace BKITrainingMain
{
	...
	public class F004_DM_MON_HOC : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "F004_DM_MON_HOC";
            this.Text = "F004_DM_MON_HOC";
            this.Load += new System.EventHandler(this.F004_DM_MON_HOC_Load);
...
,TEN_MON = 3
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(DM_MON_HOC.SO_TIN_CHI, e_col_Number.SO_TIN_CHI);
			v_htb.Add(DM_MON_HOC.MA_MON, e_col_Number.MA_MON);
			v_htb.Add(DM_MON_HOC.ID, e_col_Number.ID);
			v_htb.Add(DM_MON_HOC.TEN_MON, e_col_Number.TEN_MON);
		...
		private void insert_dm_mon_hoc(){			
			F004_DM_MON_HOC_DE v_fDE = new  F004_DM_MON_HOC_DE();								
...
//
		...
		//
		//
		private void F004_DM_MON_HOC_Load(object sender, System.EventArgs e) {
			try{
