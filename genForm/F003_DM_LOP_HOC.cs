...
/// Date: 29/03/2015 04:55:00
/// Goal: Create Form for DM_LOP_HOC
///************************************************
...
namespace BKITrainingMain
{
	...
	public class F003_DM_LOP_HOC : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(F003_DM_LOP_HOC));
			...
			// m_fg
			// 
			this.m_fg.ColumnInfo = @"4,1,0,0,0,85,Columns:0{Width:13;}	 2{Caption:""Mã Lớp"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}1{Caption:""ID"";Visible:False;DataType:System.Decimal;TextAlign:RightCenter;TextAlignFixed:CenterCenter;}3{Caption:""Tên Lớp"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}	";
			...
			this.Name = "F003_DM_LOP_HOC";
			this.Text = "F003_DM_LOP_HOC";
			this.Load += new System.EventHandler(this.F003_DM_LOP_HOC_Load);
		...
		DS_DM_LOP_HOC m_ds = new DS_DM_LOP_HOC();
		US_DM_LOP_HOC m_us = new US_DM_LOP_HOC();
		#endregion
		...
		private void us_object2grid(US_DM_LOP_HOC i_us
			, int i_grid_row) {
		...
		private void update_dm_lop_hoc(){			
		...
		private void delete_dm_lop_hoc(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
...
//
		...
		//
		//
		private void F003_DM_LOP_HOC_Load(object sender, System.EventArgs e) {
			try{
